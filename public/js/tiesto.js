document.getElementById("header").textContent = "Tiesto's Playlist";
...
// Function to add selected song to the song list and the database
async function addNewSong(song) {
    ...
    try {
        const response = await fetch('/api/addsong2', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function deleteSong(songDiv, song) {
    ...
    try {
        const response = await fetch('/api/deletesong2', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
